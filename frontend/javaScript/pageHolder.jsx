function Explore_ViewProduct(props) {
    ...
    if(showResults){
        ...
        page = <SearchProduct onSearch={handleSubmit}/>
    }
    return page;
}
    ...
    let page = (
        <div id="explore_viewProduct">
            ...
            <form id="queryForm">
                ...
                <input type="text" id="symbolInput"></input><br></br><br></br>
...
function ResultsArea() {
    let page = (
        <div id="resultsArea">
            ...
            <p id="resultsFirstRow"></p>
            <p id="resultsSecondRow"></p>
            <table id="resultsTable">
                ...
                <tr>
                    <td><b>Minimums:</b></td>
                    <td><button type="button" class="expandButton" onclick="(async () => {await toggleDetails('minimums','hiddenMinimums');})()">Toggle Section</button></td>
                </tr>
                <tr class="hiddenMinimums minimums">
                ...
                <tr>
                    ...
                    <td><button type="button" class="expandButton" onclick="(async () => {await toggleDetails('provinces','hiddenProvinces');})()">Toggle Section</button> <span id="provincesStatusButton" class="statusButton"></span></td>
                </tr>
                <tr class="hiddenProvinces provinces">
                    <td>Alberta</td>
                    <td id="AB_prov"></td>
                </tr>
                <tr class="hiddenProvinces provinces">
                ...
                <tr>
                    ...
                    <td><button type="button" class="expandButton" onclick="(async () => {await toggleDetails('transactions','hiddenTransactions');})()">Toggle Section</button> <span id="transactionsStatusButton" class="statusButton"></span></td>
                </tr>
                <tr class="hiddenTransactions transactions">
                    <td>Buy</td>
                    <td id="B_status"></td>
                </tr>
                <tr class="hiddenTransactions transactions">
                ...
                <tr>
                    ...
                    <td><button type="button" class="expandButton" onclick="(async () => {await toggleDetails('cnaccounts','hiddenCnaccounts');})()">Toggle Section</button> <span id="cnaccountsStatusButton" class="statusButton"></span></td>
                </tr>
                <tr class="hiddenCnaccounts cnaccounts">
                    <td>01</td>
                    <td id="01_CNACC"></td>
                </tr>
                <tr class="hiddenCnaccounts cnaccounts">
                ...
                <tr>
                    ...
                    <td><button type="button" class="expandButton" onclick="(async () => {await toggleDetails('niaccounts','hiddenNiaccounts');})()">Toggle Section</button> <span id="niaccountsStatusButton" class="statusButton"></span></td>
                </tr>
                <tr class="hiddenNiaccounts niaccounts">
                    <td>01</td>
                    <td id="01_NIACC"></td>
                </tr>
                <tr class="hiddenNiaccounts niaccounts">
                ...
                <tr>
                    ...
                    <td><button type="button" class="expandButton" onclick="( async () => {await toggleDetails('dividends','hiddenDividends');})()">Toggle Section</button></td>
                </tr>
                <tr class="hiddenDividends dividends">
